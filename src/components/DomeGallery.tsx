...
const DEFAULT_IMAGES = [
  { src: "/-221169957.jpg", alt: "Memory 1" },
  { src: "/-523937489.jpg", alt: "Memory 2" },
  { src: "/-607645841.jpg", alt: "Memory 3" },
  { src: "/-707310253.jpg", alt: "Memory 4" },
  { src: "/-952369650.jpg", alt: "Memory 5" },
  { src: "/-1072792537.jpg", alt: "Memory 6" },
  { src: "/-1204803283.jpg", alt: "Memory 7" },
  { src: "/-1237113290.jpg", alt: "Memory 8" },
  { src: "/-1387728735.jpg", alt: "Memory 9" },
  { src: "/-2054125556.jpg", alt: "Memory 10" },
  { src: "/-2080489042.jpg", alt: "Memory 11" },
  { src: "/83331604.jpg", alt: "Memory 12" },
  { src: "/140479127.jpg", alt: "Memory 13" },
  { src: "/202549167.jpg", alt: "Memory 14" },
  { src: "/307608503.jpg", alt: "Memory 15" },
  { src: "/682747302.jpg", alt: "Memory 16" },
  { src: "/939388702.jpg", alt: "Memory 17" },
  { src: "/1042474403.jpg", alt: "Memory 18" },
  { src: "/1243952191.jpg", alt: "Memory 19" },
  { src: "/1826708170.jpg", alt: "Memory 20" },
  { src: "/1962617314.jpg", alt: "Memory 21" },
  { src: "/2039510503.jpg", alt: "Memory 22" },
  { src: "/2103765599.jpg", alt: "Memory 23" },
];
    ...
    >
      <main ref={mainRef} className="sphere-main">
        ...
        <div className="viewer" ref={viewerRef}>
          ...
          <button
            className="dg-exit-btn"
            onClick={() => {
              const clickEvent = new MouseEvent("click", { bubbles: true });
              scrimRef.current?.dispatchEvent(clickEvent);
            }}
          >
            ✕
          </button>
